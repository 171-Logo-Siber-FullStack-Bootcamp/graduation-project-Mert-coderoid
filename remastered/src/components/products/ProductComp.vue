  ...
  <div class="card h-100 product">
    ...
    <div class="card-body product__text">
      ...
      <router-link :to="`/edit/${product.id}`">
        <button
          class="btn btn-secondary product__edit"
          style="align-self: center; justify-self: center; flex: 1; flex-direction: row; margin-left: 60px;"
...
export default {
  ...
  data() {
    return {
      currentImage: "http://localhost:3000/uploads/" + this.product.image,
      currentImageIndex: 0,
      offsetLeft: null,
      offSetTop: null,
  ...
  methods: {
    onImageChange(e) {
      ...
      const imgArrLength = this.product.image.length;
